...
public enum ErrorCode {
    ...
    USERNAME_INVALID(40005, "username must have size between 5 and 255", HttpStatus.BAD_REQUEST),
    ...
    USERNAME_NOT_EXISTS(40010, "username is not existed", HttpStatus.BAD_REQUEST),
    OTP_INVALID(40011, "otp code is wrong or expired", HttpStatus.BAD_REQUEST),
    ;
